...
class AttendanceExport implements FromArray, ShouldAutoSize, WithEvents
{
    ...
    /**
     * Get month columns mapping for external use.
     *
     * @return array
     */
    ...
    public function array(): array
    {
        ...
        $enrollmentIds = DB::table('attendances')
            ...
            ->pluck('attendances.course_enrollment_id')
            ->unique();
        ...
        // Create a mapping of student_id to enrollment_id for attendance lookups
        $studentToEnrollmentMap = $enrollments->pluck('id', 'student_id')->toArray();
        ...
        foreach ($students as $student) {
            ...
            $enrollmentId = $studentToEnrollmentMap[$student->id] ?? null;
